        ...
        return {
            ...
            link: function (scope) {
                scope.settings = [
                    ...
                    {idx: 4, title: '상품', page: 'item_add', class: '', groups: 1, icon: '../images/common/icons/ic-goods.png'},
                    {idx: 5, title: 'AI 만들기', page: 'model_make', class: '', groups: 1, icon: '../images/common/icons/ic-ai-make.png'}
                ];
                scope.options = [
